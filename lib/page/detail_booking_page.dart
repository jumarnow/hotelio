    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          itemsRoomDetail(context, 'Date', AppFormat.date(booking.date)),
          const SizedBox(height: 8),
          itemsRoomDetail(context, 'Guest', '${booking.guest} Guest'),
          const SizedBox(height: 8),
          itemsRoomDetail(context, 'Breakfast', booking.breakfast),
          const SizedBox(height: 8),
          itemsRoomDetail(context, 'Check-in Time', booking.checkInTime),
          const SizedBox(height: 8),
          itemsRoomDetail(
